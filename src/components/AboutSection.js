  ...
  return (
    <section className="about-box">
      ...
      <p>
        ...
        the work on.
        <a href="https://github.com/apluslms/a-plus"> GitHub </a>since it is
        open source.
      </p>
      <h1 className="subtitle">Education</h1>
      <p>
        I' currently planning to finnish my bachelor in computer science at
        <a href="https://aalto.fi/en"> Aalto University. </a> On top of that I'm
        studying finance at
        <a href="https://www.hanken.fi/en"> Hanken School of Economics </a> as a
        minor for my bachelor.
      </p>
    </section>
  );
}
